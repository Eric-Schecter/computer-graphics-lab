...
type Setter = (data: number[]) => void;

export class UniformHandler {
  private table = new Map<string, Setter | undefined>();
  public init = (gl: WebGL2RenderingContext, program: WebGLProgram) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      this.table.set(name, this.getPureArraySetter(gl, type, addr));
    }
  }
  ...
  public getPureArraySetter(gl: WebGL2RenderingContext, type: number, addr: WebGLUniformLocation | null) {
    ...
    switch (type) {
      ...
      // case gl.INT: case gl.BOOL: return gl.uniform1iv;
      // case gl.INT_VEC2: case gl.BOOL_VEC2: return gl.uniform2iv;
      // case gl.INT_VEC3: case gl.BOOL_VEC3: return gl.uniform3iv;
      // case gl.INT_VEC4: case gl.BOOL_VEC4: return gl.uniform4iv;
